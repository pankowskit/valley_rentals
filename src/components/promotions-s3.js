...
class PromotionsS3 extends Component{
    render(){
        return( 
            <Container fluid className="promotions-s3 bg-secondary d-flex minh-50vh align-items-center py-5 border-top border-secondary">
