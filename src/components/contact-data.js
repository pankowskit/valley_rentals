...
class ContactData extends Component{
    render(){
        ...
        return(        
            <Container fluid className={"contact-s1 bg-dark align-items-center p-0 d-flex minh-50vh "+this.props.classExt}>
                <Row className="mx-auto text-center w-100 pt-5">
                    <Col xs={10} md={6} className="mx-auto text-dark p-0"></Col>
                    <Col xs={10} md={6} className="mx-auto text-secondary p-0 d-flex align-items-center">
                        <div className="p-5">
