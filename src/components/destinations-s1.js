...
class DestinationsS1 extends Component{
    render(){
        return(    
            <Container fluid className="destinations-s1 d-flex bg-dark minh-50vh align-items-center py-5">
