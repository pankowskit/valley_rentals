...
class DestinationsS2 extends Component{
    render(){
        return(    
            <Container fluid className="destinations-s2 bg-secondary d-flex minh-50vh align-items-center py-5 border-top border-secondary">
